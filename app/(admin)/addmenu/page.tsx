    ...
    <main className="flex-1 p-10 overflow-y-auto">
      <div className="grid grid-cols-12 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select className="w-full bg-[#120F08] border border-[#2A2419] rounded-xl p-4 text-white appearance-none focus:outline-none">
          ...
          <section className="bg-[#1D1912] p-8 rounded-3xl border border-[#2A2419]">
            ...
            <div className="bg-[#262118] p-5 rounded-2xl flex justify-between items-center mb-6">
              ...
              <button
                ...
                className={`w-14 h-7 flex items-center rounded-full p-1 transition-colors duration-300 ${isAvailable ? "bg-primary" : "bg-[#332D21]"}`}
              >
                <div
        ...
        <div className="col-span-4 space-y-6">
          ...
          <button className="w-full bg-primary text-[#120F08] py-4 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-[#d98f1d] transition-all shadow-lg shadow-[#F5A623]/10">
            <Save size={20} />
            SAVE FOOD ITEM
          </button>
