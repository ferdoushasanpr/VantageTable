    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <section className="pt-20 pb-16 px-6 border-b border-gray-900">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <span className="text-primary/80 uppercase tracking-[0.2em] text-xs font-bold mb-4 block">
      ...
      <section className="py-24 px-6 bg-dark-light">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-16">Our Three Pillars</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              >
                <div className="text-primary text-4xl mb-6 italic">{i + 1}</div>
                <h3 className="text-xl font-bold mb-4">{pillar.title}</h3>
                <p className="text-gray-500 feading-relaxed">{pillar.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        <div className="bg-[#141414] rounded-3xl overflow-hidden flex flex-col md:flex-row justify-around items-center">
          <div className="md:w-1/2 p-12 lg:p-20">
            ...
            <div>
              <p className="font-bold text-primary text-lg">Julian Vane</p>
      ...
      <section className="py-20 text-center">
        <h3 className="text-2xl mb-8">Ready to experience it yourself?</h3>
        <div className="flex justify-center gap-6">
          <Link
            href="/reserve"
            className="bg-[#f4b433] text-black px-10 py-4 rounded-full font-bold hover:bg-[#e2a32b] transition-colors"
          >
            Reserve a Table
          </Link>
          <Link
            href="/menu"
            className="border border-gray-700 px-10 py-4 rounded-full font-bold hover:border-white transition-colors"
          >
            View Menu
          </Link>
        </div>
