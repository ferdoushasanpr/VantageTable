    ...
    <div className="bg-[#1a1610] border border-stone-800/50 p-8 rounded-4xl relative overflow-hidden group">
      <div className="relative z-10">
        ...
        <div className="flex items-baseline gap-4">
          <h4 className="text-6xl font-bold text-white">{value}</h4>
        </div>
      ...
      <UtensilsCrossed
        size={120}
        className="absolute -right-4 -bottom-4 text-stone-800/20 rotate-12 group-hover:scale-110 transition-transform"
      />
    </div>
  );
}
