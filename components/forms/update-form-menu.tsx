...
const UpdateFormMenu = ({ menu }: MenuProps): React.ReactNode => {
        ...
        <div className="col-span-8 space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full bg-[#120F08] border border-[#2A2419] rounded-xl p-4 text-white focus:outline-none focus:border-[#F5A623]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#120F08] border border-[#2A2419] rounded-xl p-4 text-white resize-none focus:outline-none focus:border-[#F5A623]"
                />
              </div>
            </div>
          </section>
          ...
          <section className="bg-[#1D1912] p-8 rounded-3xl border border-[#2A2419]">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="text-xl font-semibold">Availability & Options</h3>
            </div>
            ...
            <div className="bg-[#262118] p-5 rounded-2xl flex justify-between items-center mb-6">
              <div>
                ...
                <p className="text-xs text-light">
                  Toggle to show or hide this item.
                </p>
              </div>
        ...
        <div className="col-span-4 space-y-6">
          ...
          <div className="bg-[#231F16]/50 p-6 rounded-2xl border border-[#332D21] flex gap-4">
            ...
            <p className="text-xs text-light font-bold leading-relaxed">
              <span className="text-primary">PRO TIP:</span> High-quality food
