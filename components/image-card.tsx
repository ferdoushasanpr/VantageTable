    ...
    <div className="bg-[#231F16] p-4 rounded-2xl border border-[#332D21] flex gap-4 group">
      ...
      <div className="flex flex-col justify-between py-1 flex-1">
        <div>
          ...
          <p className="text-[10px] text-light uppercase tracking-wider">
            Vertical Aspect (9:16)
          </p>
        </div>

        <div className="flex gap-2">
          <button className="flex-1 bg-[#1A160F] text-primary text-xs font-bold py-2 rounded-lg border border-[#332D21] hover:bg-[#F5A623] hover:text-black transition-all flex items-center justify-center gap-1">
